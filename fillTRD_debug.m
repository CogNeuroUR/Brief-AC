function [TRD, info] = fillTRD(subjectID, nBlocks, lBlock, RespKeys, writeTRD)
  ...
  for iBlock=nBlocks:-1:1
    ...
    %
    %   YES-trial : "yes" is the correct answer
    %   NO-trial  : "no" is the correct answer
    % ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    idxCompatible = 1:length(subBlockCompatible);
    idxIncompatible = 1:length(subBlockIncompatible);
  ...
  %% TEST) Test a code
  code = 106;
  [congruency, probeType, Probe, duration] = decodeProbe_full(code, ...
  ...
  fprintf('probeType: %s | Probe: %s | Congruency: %s | duration: %d.\n',...
          probeType, Probe, congruency, duration)
